...
directory. Everything runs from `main`, where every example is the complete reference
implementation: run it, read it, change it live. Undo an experiment with
`git checkout -- examples/<chapter>`.
